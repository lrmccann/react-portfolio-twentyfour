...
const Skill = (props) => {
    ...
    return(
      ...
      >
        ...
        <AnimatedRow iconArr={frontEndTechArr} heading="Front-End Tech" uniqueKey={0} callback={openSkillModal}   />
        <AnimatedRow iconArr={backEndTechArr} heading="Back-End Tech" uniqueKey={1} callback={openSkillModal}   />
        <AnimatedRow iconArr={toolsArr} heading="Additional Tech" uniqueKey={2} callback={openSkillModal}   />;
